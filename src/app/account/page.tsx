  ...
  return (
    <Fragment>
      ...
      <div className="px-8 bg-gray-300 pb-20 py-4 lg:py-8 flex flex-row justify-between items-center">
        ...
        <button
          type="button"
          className="inline-flex items-center rounded-full px-3 py-2 text-sm font-semibold ring-1 ring-inset hover:opacity-60 ring-[var(--background)]"
        >
      ...
      <div className="m-3 lg:mx-8 py-10 px-6 lg:px-8 lg:px-12 flex gap-y-4 flex-col rounded-lg min-h-[95vh] lg:-mt-10 -mt-20 rounded-lg min-h-[95vh] -mt-20 bg-[var(--background)]/20 backdrop-blur-md">
        <ul role="list" className="divide-y divide-gray-100 border-t border-b border-gray-200">
          {accounts.map((account, index) => (
            <li key={`${account.username}_${index}`} className="flex justify-between gap-x-6 py-5 items-center">
              <div className="flex min-w-0 gap-x-4">
                <svg className="size-12 flex-none" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                </svg>
                <div className="min-w-0 flex-auto">
                  <p className="text-sm/6 font-semibold">{account.full_name}</p>
                  <p className="mt-1">{account.username}</p>
                </div>
              </div>

              <div className="z-10 rounded-full px-1 py-2 lg:p-3 font-medium border-2 border-yellow-700">
                <Link
                  className="text-sm/6 px-3"
                  href="/account/[id]"
