import { CheckIcon, CalendarIcon, PencilIcon, LinkIcon, ChevronDownIcon } from '@heroicons/react/20/solid';
import { Menu, MenuButton, MenuItems, MenuItem } from '@headlessui/react';

const PageHeader = ({data}) => {
    if(!data) return null;
    const { username, last_build_id, start_fetch_date } = data;
    return (
